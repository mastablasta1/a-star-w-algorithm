 ...
 */
public class ExtendedOutputPlan<SS extends CollectiveStateSpace<CS>, CS extends CollectiveState<?>> {
    ...
    public static <SS extends CollectiveStateSpace<CS>, CS extends CollectiveState<?>> Builder<SS, CS> newBuilder() {
        return new Builder<>();
    }
    ...
    public static final class Builder<SS extends CollectiveStateSpace<CS>, CS extends CollectiveState<?>> {
