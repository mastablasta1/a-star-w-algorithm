 ...
 */
class PlanningOperation<SS extends StateSpace<U>, S extends GlobalState<U>, U extends Comparable<U>> {
    ...
    PlanningOperation(InputPlan<SS, S, U> inputPlan) {
        ...
        paths = new ArrayList<>(inputPlan.getInitialGlobalState().getSize());
